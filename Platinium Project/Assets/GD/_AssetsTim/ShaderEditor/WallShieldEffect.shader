...
Shader "WallShieldEffect"
{
	Properties
	{
		...
		_Vitessedetilingdudissolve("Vitesse de tiling du dissolve", Range( 0 , 4)) = 0.7
		_RatioAffichageTextureHexagons("Ratio Affichage Texture - Hexagons", Vector) = (1,1,0,0)
		_SpeedtilingTextureHexagons("Speed tiling - Texture Hexagons", Range( 0 , 3)) = 0.15
		_TextureSample0("Texture Sample 0", 2D) = "white" {}
		_Transparencedumur("Transparence du mur", Range( -1 , 1)) = 0.5
		_Transparencemur("Transparence mur", Range( 0 , 1)) = 1
		_Couleurdushader("Couleur du shader", Color) = (1,1,1,0)
		_Etatdudissolve("Etat  du dissolve", Range( -1 , 1)) = -1
	...
	SubShader
	{
		...
		uniform float2 _RatioAffichageTextureHexagons;
		uniform float _SpeedtilingTextureHexagons;
		...
		{
			float mulTime47 = _Time.y * _SpeedtilingTextureHexagons;
			float2 panner51 = ( mulTime47 * float2( 0.5,0.5 ) + float2( 0,0 ));
			float2 uv_TexCoord45 = i.uv_texcoord * _RatioAffichageTextureHexagons + panner51;
			float4 tex2DNode43 = tex2D( _TextureSample0, uv_TexCoord45 );
			float4 HexaTexture_Mooving110 = tex2DNode43;
			o.Albedo = ( _Transparencemur * ( HexaTexture_Mooving110 * _Couleurdushader ) ).rgb;
			float2 temp_cast_1 = (_Transparencedumur).xx;
			float2 uv_TexCoord84 = i.uv_texcoord * temp_cast_1 + HexaTexture_Mooving110.rg;
			...
			float Dissolve64 = step( simplePerlin2D61 , _Etatdudissolve );
...
/*ASEBEGIN
Version=16100
242;73;1297;651;4715.278;1091.735;2.154913;True;False
Node;AmplifyShaderEditor.CommentaryNode;113;-4808.036,397.1695;Float;False;2333.759;607.5359;Comment;9;42;38;43;53;47;51;52;45;110;Texture Hexagon;0.5762695,1,0.514151,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;109;-2342.476,322.633;Float;False;2088.462;749.7;Comment;11;55;56;57;58;59;61;63;64;176;177;178;Dissolve;1,1,0.6084906,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-4786.036,825.6779;Float;False;Property;_SpeedtilingTextureHexagons;Speed tiling - Texture Hexagons;6;0;Create;True;0;0;False;0;0.15;0.75;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;-2292.476,542.8464;Float;False;Property;_Vitessedetilingdudissolve;Vitesse de tiling du dissolve;3;0;Create;True;0;0;False;0;0.7;4;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;52;-4324.364,616.889;Float;False;Property;_RatioAffichageTextureHexagons;Ratio Affichage Texture - Hexagons;4;0;Create;True;0;0;False;0;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;176;-1365.567,848.7416;Float;False;Property;_Etatdudissolve;Etat  du dissolve;19;0;Create;True;0;0;False;0;-1;1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;43;-3701.952,670.7491;Float;True;Property;_TextureSample0;Texture Sample 0;14;0;Create;True;0;0;False;0;ff9193904a908544e99c273139cbe678;f357425b80fb05848aa0eea343b25a3f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;110;-3308.446,691.8168;Float;True;HexaTexture_Mooving;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StepOpNode;63;-976.5203,696.5141;Float;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;64;-696.6357,697.4122;Float;True;Dissolve;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;89;-4021.158,-553.0703;Float;False;Property;_Transparencedumur;Transparence du mur;16;0;Create;True;0;0;False;0;0.5;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;171;-3631.427,-874.2049;Float;False;Property;_Couleurdushader;Couleur du shader;18;0;Create;True;0;0;False;0;1,1,1,0;1,0.6650944,0.9323423,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;133;-2324.445,1290.075;Float;False;2088.462;749.7;Comment;10;144;155;152;158;160;161;108;106;107;62;Dissolve +1;1,0.7023135,0.2688679,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;173;-3116.651,-985.8901;Float;False;Property;_Transparencemur;Transparence mur;17;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;177;-1699.472,734.5121;Float;True;Property;_TextureSample1;Texture Sample 1;15;0;Create;True;0;0;False;0;ff9193904a908544e99c273139cbe678;13bee3ac63c3c1448bc99393d73936cc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleTimeNode;106;-2003.183,1410.568;Float;False;1;0;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;107;-1801.183,1347.568;Float;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;160;-1488,1712;Float;False;Constant;_Différencepourledissolve;Différence pour le dissolve;18;0;Create;True;0;0;False;0;0.1;0.01457606;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-2287.783,1405.768;Float;False;Property;_VitesseduDissolve;Vitesse du Dissolve;5;0;Create;True;0;0;False;0;1;2.853544;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;62;-1556.902,1359.901;Float;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;178;-1274.149,338.1738;Float;True;110;HexaTexture_Mooving;1;0;OBJECT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=32A0A40F79FD078380E43030C6BAB78CCC332AA4